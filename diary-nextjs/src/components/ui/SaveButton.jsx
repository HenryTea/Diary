...
export default function SaveButton({ isDirty, onSave, onBack, saveText = "Save" }) {
  return (
    <button className="relative w-70 h-8 overflow-hidden group bg-transparent border-none p-0 flex items-center justify-center" style={{boxShadow: 'none'}}>
      ...
      >
        <span className="mr-18 flex items-center hover:bg-gray-300 rounded transition-colors px-2 py-1" onClick={onBack} title="Back to main page">
      ...
      >
        <span className="flex items-center hover:bg-green-100 rounded transition-colors px-2 py-1 mt-10" onClick={onSave} title="Save and back to Entries">
          <svg
